...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.pay = await MockBEP20.deployed();
        ...
        await this.pay.transfer(bob, '2000', { from: minter });
        await this.pay.transfer(alice, '2000', { from: minter });
        await this.pay.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.pay.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.pay.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.pay.balanceOf(this.lotteryProxyAddress)).toString(), '418');
        ...
        // console.log('pay2:', (await this.pay.balanceOf(alice, {from: alice})).toString());
